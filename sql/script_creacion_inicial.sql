...
IF OBJECT_ID('PUNTOZIP.SP_Migrar_RESERVA_ESTADOS') IS NOT NULL
DROP PROCEDURE [PUNTOZIP].SP_Migrar_RESERVA_ESTADOS
GO
...
IF OBJECT_ID('PUNTOZIP.FK_RESERVA_ESTADOS') IS NOT NULL
ALTER TABLE [PUNTOZIP].[RESERVAS] DROP CONSTRAINT [FK_RESERVA_ESTADOS]
GO
...
IF OBJECT_ID('PUNTOZIP.RESERVA_ESTADOS') IS NOT NULL
DROP TABLE [PUNTOZIP].RESERVA_ESTADOS
GO
...
CREATE TABLE [PUNTOZIP].[USUARIOS](
	...
	[usu_intentos] [numeric](12,0) NOT NULL DEFAULT(0)
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [PUNTOZIP].[RESERVA_ESTADOS](
	[ree_id] [int] IDENTITY(1,1) NOT NULL,
	[ree_descripcion] [nvarchar](255) NOT NULL
	CONSTRAINT [PK_RESERVA_ESTADOS] PRIMARY KEY CLUSTERED
	( [ree_id] ASC )WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
-------------------------------- FK_RESERVAS -------------------------------------------
GO
ALTER TABLE [PUNTOZIP].[RESERVAS]  WITH CHECK ADD CONSTRAINT [FK_RESERVA_ESTADOS] FOREIGN KEY ([rese_estado_id])
REFERENCES [PUNTOZIP].[RESERVA_ESTADOS] ([ree_id])
...
--------------------------------- MIGRACION RESERVA_ESTADOS ----------------------------------------------------
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [PUNTOZIP].[SP_Migrar_RESERVA_ESTADOS]
AS
BEGIN
	PRINT N'Migrando RESERVA_ESTADOS...';
	INSERT INTO PUNTOZIP.RESERVA_ESTADOS (ree_descripcion) VALUES ('CORRECTA'), ('MODIFICADA'), ('CANCELADA POR RECEPCION'), ('CANCELADA POR CLIENTE'), 
																  ('CANCELADA POR NO-SHOW'), ('CON INGRESO')
END
SET ANSI_NULLS ON
GO

-- Para ejecutar: EXEC PUNTOZIP.SP_Migrar_RESERVA_ESTADOS;
...
BEGIN
	...
	INSERT INTO PUNTOZIP.RESERVAS (rese_fecha_desde, rese_fecha_hasta, rese_codigo, rese_cantidad_noches, rese_estado_id)
...
BEGIN
	...
	INSERT INTO PUNTOZIP.ROLES_FUNCIONES(rf_rol_id, rf_funcion_id) VALUES (1, 1), (1, 2), (1, 3), (1, 5), (1, 6), (1, 7), (1, 10), (1, 11) -- Administrador
...
EXEC PUNTOZIP.SP_Migrar_RESERVA_ESTADOS
