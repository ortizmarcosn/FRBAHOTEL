...
namespace WindowsFormsApplication2.Facturar_Estadias
{
    public class ChargeStayHelper
    {
        public static void search(Int32 bookingId, DataGridView dgvStay)
        {
            ...
            command.CommandText = "PUNTO_ZIP.sp_facturar_estadia_booking_search";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTO_ZIP.sp_facturar_estadia_is_exist";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTO_ZIP.sp_facturar_estadia_get_charge";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTO_ZIP.sp_facturar_estadia_charge";
