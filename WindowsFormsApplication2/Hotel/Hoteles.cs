...
namespace WindowsFormsApplication2.Hotel
{
    public class Hoteles
    {
        public static int fillHotelByUser(Usuario user)
        {
            ...
            sp_rol_exist_one_by_user.CommandText = "PUNTOZIP.sp_hotel_exist_one_by_user";
        ...
        {
            ComboBoxHelper.fill(comboBox_Hotel, "PUNTOZIP.Usuario_Rol_Hotel urh INNER JOIN PUNTOZIP.Hotel h ON urh.Id_Hotel = h.Id_Hotel",
        ...
        {
            ComboBoxHelper.fill(comboBox, "PUNTOZIP.Hotel h",
