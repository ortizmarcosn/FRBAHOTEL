...
namespace WindowsFormsApplication2.Registrar_Estadia
{
    public class RegisterStayHelper
    {
        public static void search(Int32 bookingId, DataGridView dgvRegisterStay)
        {
            ...
            command.CommandText = "PUNTOZIP.sp_estadia_booking_search";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTOZIP.sp_estadia_booking_is_exist";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTOZIP.sp_estadia_booking_is_cancel";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTOZIP.sp_estadia_booking_is_before";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTOZIP.sp_estadia_booking_is_hotel";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTOZIP.sp_estadia_generate_stay";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTOZIP.sp_estadia_cancel_is_after_date_check_in";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTOZIP.sp_estadia_is_for_check_in";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTOZIP.sp_estadia_exist_full_stay";
        ...
        public static void saveStayClients(int stayId, List<int> clientsIds)
        {
            ...
            {
                SqlCommand command = new SqlCommand();
                command.CommandText = "PUNTOZIP.sp_estadia_save_stay_client";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTOZIP.sp_estadia_generate_checkout";
