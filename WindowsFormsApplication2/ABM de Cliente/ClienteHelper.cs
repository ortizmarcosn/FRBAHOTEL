...
namespace WindowsFormsApplication2.ABM_de_Cliente
{
    public class ClienteHelper
    {
        public static void search(Cliente client, DataGridView dgvClient)
        {
            ...
            command.CommandText = "PUNTOZIP.sp_client_search";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTOZIP.sp_client_enable_disable";
        ...
        public static Cliente getClientData(String clientId)
        {
            ...
            command.CommandText = "PUNTOZIP.sp_client_data_get_by_id_client";
        ...
        public static Int32 save(Cliente clientData)
        {
            ...
            sp_save_or_update_client.CommandText = "PUNTOZIP.sp_client_save_update";
        ...
        public static Boolean checkTypeAndDocumentNumber(Int32 clientId, String typeDocument, Int32 documentNumber)
        {
            ...
            sp_client_check_exist_document.CommandText = "PUNTOZIP.sp_client_check_exist_document";
        ...
        public static Boolean checkMail(Int32 clientId, String mail)
        {
            ...
            sp_client_check_exist_mail.CommandText = "PUNTOZIP.sp_client_check_exist_mail";
