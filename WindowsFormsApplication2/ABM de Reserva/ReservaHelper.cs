...
namespace WindowsFormsApplication2.ABM_de_Reserva
{
    public class ReservaHelper
    {
        public static void search(Reserva reserva, DataGridView dgvReserva)
        {
            ...
            command.CommandText = "PUNTOZIP.sp_reserva_listar";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTOZIP.sp_hotel_regimen_retrieve";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTOZIP.sp_tipo_habitacion_available";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTOZIP.sp_reserva_occupied";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTOZIP.check_availability";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTOZIP.sp_check_hotel_availability";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTOZIP.sp_get_reserva";
        ...
        {
            SqlCommand command = new SqlCommand();
            command.CommandText = "PUNTOZIP.sp_assign_room";
        ...
        {
            ComboBoxHelper.fill(comboHotel, "PUNTOZIP.Hotel h",
